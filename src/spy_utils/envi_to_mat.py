...
def to_simple(envi_input, img, mat_output, bands=None):
    """
...
def to_happy(envi_input, img, mat_output, bands=None):
    """
...
def convert(envi_input, mat_output, bands=None, conversion=CONVERSION_SIMPLE):
    ...
    if conversion == CONVERSION_SIMPLE:
        to_simple(envi_input, img, mat_output, bands)
    elif conversion == CONVERSION_HAPPY:
        to_happy(envi_input, img, mat_output, bands)
    else:
